...
{
    public static Talon rearRightTop = new Talon(0);
    public static Talon rearRightBottomRight = new Talon(1);
    public static Talon rearRightBottomLeft = new Talon(2);
    public static Talon rearLeftTop = new Talon(14);
    public static Talon rearLeftBottomRight = new Talon(15);
    public static Talon rearLeftBottomLeft = new Talon(16);
	...
	public void driveRobotBase(){
		...
		rDrive.tankDrive(Robot.oi.getXboxYAxis(), Robot.oi.getXboxXAxis());
	}
	//AUTO STUFF
