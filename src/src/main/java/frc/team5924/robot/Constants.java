...
{
    public static final int kElevatorMasterId = 0;
    public static final int kElevatorLeftSlaveId = 0;

    public static int d_rearRightTop = 0;
    public static int d_rearRightBottomRight = 1;
    public static int d_rearRightBottomLeft = 2;
    public static int d_rearLeftTop = 10;
    public static int d_rearLeftBottomRight = 9;
    public static int d_rearLeftBottomLeft = 7;
    ...
    public static final int ELEVATOR_TOP_SWITCH_CHANNEL = 10;
    public static final int ELEVATOR_BOTTOM_SWITCH_CHANNEL = 11;
